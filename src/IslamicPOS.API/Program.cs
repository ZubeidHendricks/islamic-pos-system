...
using IslamicPOS.Core.Validators;
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    { 
        Title = "Islamic POS API", 
        Version = "v1",
        Description = "API for Islamic Point of Sale System with Profit Sharing",
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Islamic POS API V1");
